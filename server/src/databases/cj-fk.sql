...
--
ALTER TABLE `posts`
  ADD CONSTRAINT `posts_ibfk_1` FOREIGN KEY (`member_id`) REFERENCES `users_information` (`member_id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
ALTER TABLE `post_like`
  ...
  ADD CONSTRAINT `post_like_ibfk_3` FOREIGN KEY (`member_id`) REFERENCES `users_information` (`member_id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
