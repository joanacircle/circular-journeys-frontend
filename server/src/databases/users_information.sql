...
--
-- Host: localhost:8889
-- Generation Time: Feb 15, 2023 at 03:32 PM
...
CREATE TABLE `users_information` (
  ...
  `postalCode` varchar(10) DEFAULT NULL COMMENT '郵遞區號',
...
INSERT INTO `users_information` (`id`, `member_id`, `created_at`, `active_status`, `points`, `ticket`, `first_name`, `last_name`, `birthday`, `sex`, `password`, `verify`, `token`, `email`, `telephone`, `nation`, `city`, `districts`, `postalCode`, `address`, `payment_type`, `provider`, `account_no`, `expiry`) VALUES
(1, '123456', '2022-12-21 02:44:42', 1, 9457, 2, 'Chou', 'Alan', '1995-04-14', 'm', 'e10adc3949ba59abbe56e057f20f883e', 'GjG0ecsns', 'dc756407-f3c5-41bd-8828-2f4691c83eac', 'alanchou19950414@gmail.com', '0970688851', '臺灣', ' 臺中市', '太平區', '80711', '環中東路三段507號6樓之6', '信用卡', 'VISA', '1111 2222 3333 4444', '2022-12-21'),
